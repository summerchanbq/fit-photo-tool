/* Fit Photo V84 phone capture. No third-party JavaScript, no desktop editor dependencies.
...
(function(){
'use strict';
var BUILD='V84-20260908-R1',API='https://qrtfvatqrtliluwtkkxg.supabase.co',KEY='sb_publishable_tSBEuKB56T01zCJZxIadtw_MD7t6S6N';
...
function privateURL(){var url=new URL('capture.html',location.href);url.search='?v=84-20260908-r1';url.hash=sessionId&&sessionToken?'session='+encodeURIComponent(sessionId)+'&token='+encodeURIComponent(sessionToken):'';return url.href;}
